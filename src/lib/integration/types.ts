...
export interface IntegratedUserProfile {
  ...
  leaderboard: {
    ...
    subjects: SubjectLeaderboard[]
  }
  tournaments: TournamentMode[]
...
export interface GamificationAnalytics {
  ...
  byCategory: {
    learning: AchievementAnalytics
    social: AchievementAnalytics
    streak: AchievementAnalytics
    mastery: AchievementAnalytics
    exploration: AchievementAnalytics
  }
  leaderboard: {
...
export interface LearningGamificationCorrelation {
  userId: string
  correlations: {
  ...
  recommendations: {
    forLearning: string[]
    forGamification: string[]
    forEngagement: string[]
  }
}

export interface UnifiedDashboardData {
  user: IntegratedUserProfile
  school: {
    analytics: SchoolMetrics
    gamification: GamificationAnalytics
    correlations: LearningGamificationCorrelation[]
  }
  realTime: {
    activeUsers: number
