...
-- This table helps organize questions by topics within each subtest
...
CREATE TABLE IF NOT EXISTS topics (
  ...
  -- Foreign key constraint to ensure subtest_code exists
  CONSTRAINT fk_topics_subtest_code 
